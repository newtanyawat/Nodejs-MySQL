...
const store_data = time_1.schedule('*/10 * * * * *', async() => { // (*second) (*minute) (*hour) (*day of month) (*month) (*day of week)
  try {
    let data_sensor = await getdata.get('http://192.168.1.115/getscale') // รับค่าจาก NODEMCU SENSOR DHT (TEMP,HUMI)
    // console.log("--------------------------------");
